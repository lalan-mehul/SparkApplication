...
public class LoadingFileFromDiskExample {
    ...
    public static void main(String[] args) {
        ...
        try (JavaSparkContext context = new JavaSparkContext(conf)) {
            JavaRDD<String> subtitleLines = context.textFile("src/main/resources/subtitles/input-spring.txt");
            ...
            JavaPairRDD<Long, String> swappedRDD =  wordsSummed.mapToPair(tuple -> new Tuple2<>(tuple._2,tuple._1));
            System.out.println("Number of partitions: " + swappedRDD.getNumPartitions());
            System.out.println("Top 10 elements are: ");
            swappedRDD.sortByKey(false).take(10).forEach(System.out::println);
            System.out.println("All sorted elements after collect call are: ");
            swappedRDD.sortByKey(false).collect().forEach(System.out::println);
